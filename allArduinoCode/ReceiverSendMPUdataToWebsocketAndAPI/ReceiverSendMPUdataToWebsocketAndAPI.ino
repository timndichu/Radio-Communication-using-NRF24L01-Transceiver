...
//api
const char* serverName = "http://nanosat.herokuapp.com/postTempReadings";
...
void httpPOST(){
  ...
  DynamicJsonDocument postMessage(32);
  postMessage["data"] = "Hi I'm ESP8266";
  
  String jsonBody;
  serializeJson(postMessage, jsonBody);
  
  char *url = "http://nanosat.herokuapp.com/dashboard/postTempReadings";
